        ...
        <Box className="colorBackgroundContentGold h-max py-10">
          <Container maxWidth="xl">
            <Grid container spacing={5}>
              ...
              <Grid item xs={12}>
                <center>
                  <Button className="text-[#303030] ring-2 ring-[#303030] border-[#303030] font-bold bg-[#FFCF76] hover:bg-[#ffbd44] focus:ring-4 focus:outline-none focus:ring-[#303030] rounded text-sm px-5 py-2.5 text-center inline-flex items-center">
                    See More
