                        ...
                        <Grid item xs={12} md={7}>
                            ...
                            {loading ? (<Skeleton animation="wave" variant="rectangular" className="w-full h-32 rounded-md" />) : (
                                <Grid item className="mt-8 space-x-4 max-sm:text-center" >
                                    <Button variant="contained" className="w-[45%] p-3 bg-red-400 hover:bg-red-500 text-white font-bold text-xl max-lg:text-lg max-sm:text-[16px]">Add&nbsp;to&nbsp;Favorite</Button>
